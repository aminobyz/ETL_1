...
#         # API token
#         api_token = "ZGV2aWNlO2Fwb2xsb246ZGVkOWYxOTAtNzkxMy0xMWYwLTk1MzQtYTE3Nzk5MDAyZmU5"

#         # The API endpoint URL
#         api_url = "https://api.etos-webservice.de/service/apollon/api/aggregate/stock"
